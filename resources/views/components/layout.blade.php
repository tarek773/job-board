                        ...
                        <div class="hidden md:block">
                            <div class="ml-10 flex items-baseline space-x-4">
                                <x-nav-link href="/" aria-current="page"
                                    :active="request()->is('/')">Dashboard</x-nav-link>
                                <x-nav-link href="/about" aria-current="page"
                                    :active="request()->is('about')">About</x-nav-link>
                                <x-nav-link href="/contact" aria-current="page"
                                    :active="request()->is('contact')">Contact Us</x-nav-link>
                            </div>
                        </div>
                    </div>
                    <div class="hidden md:block">
